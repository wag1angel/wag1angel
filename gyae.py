...
def introduction():
    ...
    # Add title
    LBL_title = tk.Label(master=FRM_anvandar_INFO, text="Aim Trainer", font=("open sans", 30, "bold"), pady=20, bg='black', fg='magenta2')
    LBL_title.pack()
    ...
    LBL_anvandare = tk.Label(master=FRM_center, text="Välj användarnamn: ", font=("open sans", 20), pady=10, bg='black', fg='magenta2')
    LBL_anvandare.pack()

    ENT_anvandarnamn = tk.Entry(master=FRM_center, font=("open sans", 12), bg='black', fg='magenta2')
...
def spel_nivaer():
    ...
    LBL_niva = tk.Label(master=FRM_nivaer, text="välj nivå:", pady=5, font=("open sans", 15), background='black', foreground='magenta2')
    LBL_niva.pack()
...
def spel_layout(anvandarnamn: str, difficulty: List):
    ...
    LBL_anvandarnamn = tk.Label(master=FRM_INFO, text=anvandarnamn, font=("open sans", 15), fg='magenta2', bg='black')
    LBL_POINTS = tk.Label(master=FRM_INFO, text=0, font=("open sans", 15), fg='magenta2', bg='black')
    LBL_tid = tk.Label(master=FRM_INFO, text=10, font=("open sans", 15), fg='magenta2', bg='black')
...
def timer():
    ...
    if LBL_tid['text'] == 0:
        ...
        LBL_poang = tk.Label(master=FRM_spel, text=f"Poäng  : {LBL_POINTS['text']}", font=("open sans", 20), bg="black", fg="#EE82EE")
